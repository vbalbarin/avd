...
# Add registry keys
[string]$WinStationsKey = 'HKLM:\SYSTEM\CurrentControlSet\Control\Terminal Server\WinStations'
$WinStationKeyValues = (
...
if ($ExcludeLocalUserAccountName) {
  Add-LocalGroupMember -Group "FSLogix Profile Exclude List" -Member $ExcludeLocalUserAccountName
}